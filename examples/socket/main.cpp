...
int main(int argc, char* argv[])
{
...

	{
		...
		kn::lTCPSocket a_socket(kn::Endpoint("avalon.ybalrid.info:80"));
		a_socket.connect();
...

	{
		...
		kn::lUDPSocket a_socket(kn::Endpoint(addr_send, 6666));

		//Socket used to receive, the "endpoint" is where to listen to data
		kn::lUDPSocket b_socket(kn::Endpoint(addr_recv, 6666));
		b_socket.bind();
		...
		auto from = b_socket.getRecvEndpoint();
	...
	{
		kn::lTCPSocket listener(kn::Endpoint("0.0.0.0:6666"));
